...
public class AssessmentReceiver extends BroadcastReceiver {
    String channel_id = "Assessment";
    static int notificationID;


    @Override
    public void onReceive(Context context, Intent intent) {
        Toast.makeText(context, intent.getStringExtra("Assessment"), Toast.LENGTH_SHORT).show();
    ...
    private void createNotificationChannel(Context context, String CHANNEL_ID) {
        ...
        String description = context.getResources().getString(R.string.channel_description2);
